...
public class TsscGame implements Serializable {
	...
	@NotNull(message = "Debes ingresar una fecha", groups=GameValidated.class)
	@Column(name = "SCHEDULED_DATE")
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	private LocalDate scheduledDate;
	
	@NotNull(message = "Debes ingresar una hora", groups=GameValidated.class)
	...
	public TsscGame() {
		...
		tsscTimecontrols = new ArrayList<>();		
