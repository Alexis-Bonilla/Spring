...
public class TsscStory implements Serializable {
	...
	@Min(value = 1, message ="El valor del negocio debe ser mayor a 0", groups=StoryValidated.class)
	@Column(name = "BUSINESS_VALUE")
	private BigDecimal businessValue;

	private String description;
	@Min(value = 1, message ="El valor del sprint inicial debe ser mayor a 0", groups=StoryValidated.class)
	@Column(name = "INITIAL_SPRINT")
	private BigDecimal initialSprint;

	@Column(name = "ST_NUMBER")
	private BigDecimal number;
	@Min(value = 1, message ="El valor de prioridad debe ser mayor a 0", groups=StoryValidated.class)
	...
	@NotNull(message = "Dener�as seleccionar un juego", groups=StoryValidated.class)
	@ManyToOne
